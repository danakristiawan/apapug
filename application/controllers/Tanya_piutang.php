...
class Tanya_piutang extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['tanya'] = $this->db->get_where('data_pertanyaan', ['jenis_id' => 3])->result_array();
    // form
    $this->load->view('template/header');
    $this->load->view('template/sidebar', $data);
    $this->load->view('template/topbar', $data);
    $this->load->view('tanya_piutang/index', $data);
  ...
  public function add()
  {
    ...
    $this->load->view('template/sidebar', $data);
    $this->load->view('template/topbar', $data);
    $this->load->view('tanya_piutang/add', $data);
    $this->load->view('template/footer');
  }
  ...
  public function edit($id = null)
  {
    ...
    $this->load->view('template/sidebar', $data);
    $this->load->view('template/topbar', $data);
    $this->load->view('tanya_piutang/edit', $data);
    $this->load->view('template/footer');
  }
